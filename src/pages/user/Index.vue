<template>
  <q-page padding>
    ...
    <q-carousel
      ...
      swipeable
    >
      <q-carousel-slide :name="1" img-src="https://pmcdeadline2.files.wordpress.com/2020/07/netflixjpg.png?w=681&h=383&crop=1" />
      <q-carousel-slide :name="2" img-src="https://pmcdeadline2.files.wordpress.com/2020/07/netflixjpg.png?w=681&h=383&crop=1" />
      <q-carousel-slide :name="3" img-src="https://pmcdeadline2.files.wordpress.com/2020/07/netflixjpg.png?w=681&h=383&crop=1" />
      <q-carousel-slide :name="4" img-src="https://cdn-cas.orami.co.id/parenting/images/film-terbaru-di-bulan-november-2.original.jpegquality-90.jpg" />
    </q-carousel>
    </div>
